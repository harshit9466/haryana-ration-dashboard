...
**Body encoding (⚠️ inconsistent — Phase 1/3 me discover kiya):**
...
- **API 6 galat captcha** → govt `HTTP 400 { "responseMessage": "Captcha Invalid" }`
  (`epos.ts` `allow4xx` option se handle — UI naya captcha maangta hai)
